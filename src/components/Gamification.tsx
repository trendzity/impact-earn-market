  ...
  <section className="section-padding">
    <div className="container mx-auto">
      <div className="text-center mb-16">
        <span className="text-sm text-accent font-medium uppercase tracking-wider">Gamification</span>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {features.map((f, i) => (
          <motion.div
            ...
            className="glass-card rounded-2xl p-8 text-center hover:border-accent/30 transition-colors group"
          >
